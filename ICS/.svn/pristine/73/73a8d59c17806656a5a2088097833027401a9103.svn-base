...
Public Class ImarkConformityMarkReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ImarkConformityMarkReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_List_of_Tire_Pm_PRODUCTDATA_REPORT_VIEWFAMILY() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedImarkConformityMarkReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ImarkConformityMarkReport = New ImarkConformityMarkReport
        rpt.Site = Me.Site
        Return rpt
    End Function
