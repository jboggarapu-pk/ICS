...
''' </summary>
''' <remarks></remarks>
Public Class IndiaMarkcertificationPresenter
...
#Region "Members"
    ...
    ''' <summary>
    ''' changed to IIndiaMarkCertificationView
    ''' </summary>
    ''' <remarks></remarks>
    Private m_view As IIndiaMarkCertificationView

#End Region

#Region "Constructors"

    Public Sub New(ByVal p_view As IIndiaMarkCertificationView)
...
#Region "Methods"
    ...
    Protected Overrides Function MapViewToCertificate() As Certificate
        ...
        Try
            ...
            objCertificate.CertificationTypeName = "India_Mark" 'NameAid.Certification.India_Mark.ToString()
            ...
            objCertificate.ProductLocation = m_view.IndiaMark_ProductLocation
            objCertificate.JobReportNumber_CEN = m_view.IndiaMark_JobReportNumber
    ...
    Protected Overrides Sub MapCertificateToView(ByVal p_objCertificate As Certificate)
        ...
        m_view.IndiaMark_JobReportNumber = p_objCertificate.JobReportNumber_CEN
        ...
        m_view.IndiaMark_ProductLocation = p_objCertificate.ProductLocation
