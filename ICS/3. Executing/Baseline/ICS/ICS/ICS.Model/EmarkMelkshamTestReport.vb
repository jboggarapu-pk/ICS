...
Public Class EmarkMelkshamTestReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EmarkMelkshamTestReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmarkMelkshamTestReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmarkMelkshamTestReport = New EmarkMelkshamTestReport
        rpt.Site = Me.Site
        Return rpt
    End Function
