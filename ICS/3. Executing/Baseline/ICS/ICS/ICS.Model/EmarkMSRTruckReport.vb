...
Public Class EmarkMSRTruckReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EmarkMSRTruckReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmarkMSRTruckReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmarkMSRTruckReport = New EmarkMSRTruckReport
        rpt.Site = Me.Site
        Return rpt
    End Function
