...
''' <summary>
''' jeseitz added this file 6/8/2016
''' </summary>
''' <remarks></remarks>
...
#Region "Properties"
    ...
    Public ReadOnly Property CertificationType() As Integer Implements Presenter.IGeneralCertificationView.CertificationType
        Get
            Return Session("certificationsearchex_aspx" & "GeneralCertificationTypeID")
    ...
    'Public Property FormTitle() As String Implements IGeneralCertificationView.CertTypeName
    '    Get
    ...
    'Public Property CertTypeName() As String Implements IGeneralCertificationView.CertTypeName
    '    Get
    '        Return lblCertTypeName.Text
    '    End Get
    '    Set(ByVal value As String)
    '        lblCertTypeName.Text = Session("certificationsearchex_aspx" & "GeneralCertificationTypeName")
    '    End Set
    'End Property

    'Public Property CertTypeID() As Integer Implements IGeneralCertificationView.CertTypeID
    '    Get
    '        If lblCertTypeID.Text = "" Then
    '            Return 0
    '        Else
    '            Return lblCertTypeID.Text
    '        End If
    ...
    '    End Get
    '    Set(ByVal value As Integer)
    '        lblCertTypeID.Text = Session("certificationsearchex_aspx" & "GeneralCertificationTypeID")
    '    End Set
    'End Property
#End Region
...
#Region "Methods"
    ...
    Protected Sub Click_Yes(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim intCertificationTypeID As Integer = Me.lblCertTypeID.Text
    ...
    Public Sub SetupDefaultValuesView() Implements Presenter.ICertificationView.SetupDefaultValuesView
        ...
        If Me.CertificateNumberID > 0 Then
            Dim strUrl = "CertificationDefaults.aspx" & "?CertificationType=" & Me.lblCertTypeID.Text & "&CertificateNumberID=" & Me.CertificateNumberID.ToString()
    ...
    Public Sub DoLoadView() Implements Presenter.ICertificationView.DoLoadView
        lblCertTypeID.Text = Session("certificationsearchex_aspx" & "GeneralCertificationTypeID")
        lblCertTypeName.Text = Session("certificationsearchex_aspx" & "GeneralCertificationTypeName")
        'lblCertTypeID.Text = CertTypeID.ToString
        'lblCertTypeName.Text = CertTypeName
