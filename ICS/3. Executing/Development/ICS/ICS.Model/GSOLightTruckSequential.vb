...
Public Class GSOLightTruckSequential
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GSOLightTruckSequential.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGSOLightTruckSequential
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GSOLightTruckSequential = New GSOLightTruckSequential
        rpt.Site = Me.Site
        Return rpt
    End Function
