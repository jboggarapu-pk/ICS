...
Public Class EmarkSimilarCertificate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EmarkSimilarCertificate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmarkSimilarCertificate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmarkSimilarCertificate = New EmarkSimilarCertificate
        rpt.Site = Me.Site
        Return rpt
    End Function
