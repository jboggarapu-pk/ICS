...
Public Class EmarkLightTruckCertification
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EmarkLightTruckCertification.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SkuDifferences_Pm_CERTIFICATECERTIFICATENUMBER() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEmarkLightTruckCertification
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmarkLightTruckCertification = New EmarkLightTruckCertification
        rpt.Site = Me.Site
        Return rpt
    End Function
