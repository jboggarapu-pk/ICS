...
Public Class CCCSequentialReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CCCSequentialReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCCCSequentialReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CCCSequentialReport = New CCCSequentialReport
        rpt.Site = Me.Site
        Return rpt
    End Function
