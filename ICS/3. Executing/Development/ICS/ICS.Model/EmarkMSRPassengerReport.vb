...
Public Class EmarkMSRPassengerReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EmarkMSRPassengerReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmarkMSRPassengerReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmarkMSRPassengerReport = New EmarkMSRPassengerReport
        rpt.Site = Me.Site
        Return rpt
    End Function
