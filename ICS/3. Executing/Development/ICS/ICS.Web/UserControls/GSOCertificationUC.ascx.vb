...
#Region "Members"
    ...
    ''' <summary>
    '''  Constant to hold TempBatchNum text
    ''' </summary>
    Private Const TempBatchNumText As String = "txtTempBatchNum"
    ''' <summary>
    '''  Constant to hold GSOBatchNum text
    ''' </summary>
    Private Const GSOBatchNumText As String = "txtGSOBatchNum"
    ''' <summary>
...
#Region "Methods"
    ...
    Protected Sub Click_Update(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            strCertifName = GSOText

            tbTempBatchNumber = CType(pnlBatchNumMassUpdate.FindControl(TempBatchNumText), TextBox)
            strTempBatchNumber = tbTempBatchNumber.Text

            tbGSOBatchNumber = CType(pnlBatchNumMassUpdate.FindControl(GSOBatchNumText), TextBox)
    ...
    ''' <summary>
    ''' Batch Number Mass Update Click.
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <exception cref="Exception">
    ...
    Private Sub btnBatchNumMassUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBatchNumMassUpdate.Click
        Try
            ...
            tbTempBatchNum = CType(pnlBatchNumMassUpdate.FindControl(TempBatchNumText), TextBox)
            tbTempBatchNum.Text = BatchNumber

            tbGSOBatchNum = CType(pnlBatchNumMassUpdate.FindControl(GSOBatchNumText), TextBox)
            tbGSOBatchNum.Text = ""
