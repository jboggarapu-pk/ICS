<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="GeneralCertificationUC.ascx.vb" Inherits="CooperTire.ICS.Web.GeneralCertificationUC" %>
...
<asp:Panel ID="pnlGeneralCert" runat="server" Visible="True">
    <asp:Panel ID="pnlGeneralCertificate" runat="server" Visible="True" CssClass="UCPanel">       
        <table>
            <tr>
                <td align="right">
                    <asp:Label ID="lblCertTypeName" runat="server" ></asp:Label> 
                    <asp:Label ID="lblCertTypeID" runat="server" Visible="False" ></asp:Label>
            ...
            <tr>
                ...
                <td colspan="3" align="left"> <%--yfye 11/21/2011--%>
                    <validation:PropertyProxyValidator ID="ppvJob" runat="server" ControlToValidate="txtJobReportNo"
                        PropertyName="JobReportNumber_CEN" RulesetName="General" SetFocusOnError="True" SourceTypeName="CooperTire.ICS.DomainEntities.Certificate"></validation:PropertyProxyValidator></td>
            </tr>
            <tr>
                <td align="right">
            ...
            <tr>
                ...
                <td colspan="3" align="left">
                    <validation:PropertyProxyValidator ID="ppvCertDateApproved" runat="server" ControlToValidate="txtCertDateApproved"
                        PropertyName="CertDateApproved_CEGI" SetFocusOnError="True" SourceTypeName="CooperTire.ICS.DomainEntities.Certificate" RulesetName="General"></validation:PropertyProxyValidator></td>
            </tr>
             <tr>
                <td align="right">
                ...
                <td align="left">
                    <validation:PropertyProxyValidator ID="ppvGeneralExpirydate" runat="server" ControlToValidate="txtDateExpiry"
            ...
            <tr>
                ...
                <td colspan="3" align="left">
                    <validation:PropertyProxyValidator ID="ppvDateApproved" runat="server" ControlToValidate="txtDateApproved"
                        PropertyName="DateApproved_CEGI" SetFocusOnError="True" SourceTypeName="CooperTire.ICS.DomainEntities.Certificate" RulesetName="General"></validation:PropertyProxyValidator></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" align="left">
                    <validation:PropertyProxyValidator ID="ppvOperDateApproved" runat="server" ControlToValidate="txtOperDateApproved"
                        PropertyName="OperDateApproved" SetFocusOnError="True" SourceTypeName="CooperTire.ICS.DomainEntities.Certificate" RulesetName="General"></validation:PropertyProxyValidator></td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td colspan="3" align="left">
                    <validation:PropertyProxyValidator ID="ppvProductLocation" runat="server" PropertyName="ProductLocation"
                        RulesetName="General" SetFocusOnError="True" SourceTypeName="CooperTire.ICS.DomainEntities.Certificate"
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnGettestResult" runat="server" Text="Get Results" Visible="False" />
                </td>
