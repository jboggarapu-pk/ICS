<%@ Control Language="vb" AutoEventWireup="false" Codebehind="CCCCertificationUC.ascx.vb"
    Inherits="CooperTire.ICS.Web.CCCCertificationUC" %>
...
<asp:Panel ID="pnlCCC" runat="server" Visible="True">
    <asp:Panel ID="pnlCCCCertificate" runat="server" Visible="True" CssClass="UCPanel">       
        <table>
            <tr>
                <td align="right">
                    <asp:Label ID="lblFormTitle" runat="server" Text="CCC"></asp:Label>
            ...
            <tr>
                ...
                <td colspan="3" align="left">
                    <validation:PropertyProxyValidator ID="ppvJob" runat="server" ControlToValidate="txtJobReportNo"
                        PropertyName="JobReportNumber_CEN" RulesetName="CCC" SetFocusOnError="True" SourceTypeName="CooperTire.ICS.DomainEntities.Certificate"></validation:PropertyProxyValidator></td>
            </tr>
            <tr>
                <td align="right">
            ...
            <tr>
                ...
                <td colspan="3" align="left">
                    <validation:PropertyProxyValidator ID="ppvDateApproved" runat="server" ControlToValidate="txtDateApproved"
                        PropertyName="DateApproved_CEGI" SetFocusOnError="True" SourceTypeName="CooperTire.ICS.DomainEntities.Certificate" RulesetName="CCC"></validation:PropertyProxyValidator></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" align="left">
                    <validation:PropertyProxyValidator ID="ppvOperDateApproved" runat="server" ControlToValidate="txtOperDateApproved"
                        PropertyName="OperDateApproved" SetFocusOnError="True" SourceTypeName="CooperTire.ICS.DomainEntities.Certificate" RulesetName="CCC"></validation:PropertyProxyValidator></td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td colspan="3" align="left">
                    <validation:PropertyProxyValidator ID="ppvProductLocation" runat="server" PropertyName="ProductLocation"
                        RulesetName="CCC" SetFocusOnError="True" SourceTypeName="CooperTire.ICS.DomainEntities.Certificate"
