<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Emark117CertificationUC.ascx.vb"
    Inherits="CooperTire.ICS.Web.Emark117CertificationUC" %>
...
<asp:Panel ID="pnlEmark" runat="server" Visible="True">
    <asp:Panel ID="pnlEmarkCertificate" runat="server" Visible="True" CssClass="UCPanel">
        <table>
            <tr>
                <td align="right">
                    <asp:Label ID="lblFormTitle" runat="server" Text="ECE-117"></asp:Label>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblSupplementalMoldStamping" runat="server" Text="Mold  Stamping (+S +SW01) :"
                        Width="172px"></asp:Label></td>
                <td>
                    <asp:TextBox ID="txtSupplementalMoldStamping" runat="server"></asp:TextBox></td>
                <td colspan="3" align="left">
                    <validation:PropertyProxyValidator ID="ppvSupplementalMold" runat="server" ControlToValidate="txtSupplementalMoldStamping"
                        PropertyName="SupplementalMoldStamping_E" RulesetName="Emark" SetFocusOnError="True"
            ...
            <tr>
                ...
                <td colspan="3" align="left">
                    <validation:PropertyProxyValidator ID="ppvMaterailNo" runat="server" ControlToValidate="txtMaterialNo"
