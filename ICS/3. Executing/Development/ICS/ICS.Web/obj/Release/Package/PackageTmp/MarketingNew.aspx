<%@ Page Language="vb" MasterPageFile="~/ICS.Master" AutoEventWireup="false" Codebehind="MarketingNew.aspx.vb"
    Inherits="CooperTire.ICS.Web.MarketingNew" Title="Marketing Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphICSContentHolder" runat="Server">
    <div id="up_container" style="width: 100%">
        <asp:UpdatePanel ID="upnlUpdatePanelMarketing" runat="server">
            <ContentTemplate>
                <asp:Label ID="lblInfo" runat="server" Text="Please select Brand and Brand Line to view the related certification requests"></asp:Label><br />
                ...
                <table style="width: 688px; position: static;">
                    ...
                    <tr style="height: 100%; width: 100%;" valign="top">
                        <td style="width: 100%; height: 89%;" align="center" colspan="4">
                            <asp:GridView ID="grdCert" SkinID="Professional" runat="server" HorizontalAlign="Left"
                                AutoGenerateColumns="False" Font-Size="X-Small" AllowPaging="true" PageSize="10"
                                PagerStyle-HorizontalAlign="Left" OnPageIndexChanging="grdCert_PageIndexChanging" OnRowDataBound="grdCert_RowDataBound" >
                            </asp:GridView>
                        </td>
                    </tr>
                    <tr>
